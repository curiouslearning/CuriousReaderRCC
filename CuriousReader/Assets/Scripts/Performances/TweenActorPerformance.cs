...
namespace CuriousReader.Performance
{
    ...
    public abstract class TweenActorPerformance : Performance
    {
        ...
        public TweenCallback OnComplete;
        public bool YoYo;
        public virtual TweenActorPerformance Init(Vector3 i_vStartPosition, Vector3 i_vEndPosition, float i_duration = 1f, float i_speed = default(float), bool i_AllowInterrupt = true, TweenCallback i_callback = default(TweenCallback), bool i_yoyo = false, List<GameObject> i_rcInvokers = null)
        {
